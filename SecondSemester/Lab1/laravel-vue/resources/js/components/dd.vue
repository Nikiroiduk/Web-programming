				...
				*/
				for( var i = 0; i < this.files.length; i++ ){
					...
					if (file.name.split(".").pop() == "xlsx"){
						formData.append('exelFile', file);
						break;
					}
				}

				console.log(formData.get("exelFile"));
				...
				reader.readAsBinaryString(formData.get("exelFile"));
				
				fetch("app/Http/Controllers/setData.php", {
					method: "POST",
					body: JSON.stringify({
						id: 0,
						title: "Name",
